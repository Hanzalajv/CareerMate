...
export default function ChatPage() {
    ...
    useEffect(() => {
        getCurrentUser().then(async u => {
            ...
            if (data.chat_history) {
                ...
                const greeting = {
                    role: 'assistant',
                    content: `Hello ${data.display_name}! 👋 I'm your AI career coach. I've reviewed your profile and onboarding answers. What would you like to discuss today? I can help you:\n\n• Explore career paths in more detail\n• Understand required skills for specific careers\n• Get advice on next steps\n• Answer questions about job markets\n\nWhat's on your mind?`
                }
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            await supabase
                .from('user_profiles')
                .update({ chat_history: [...messages, userMessage, assistantMessage] })
                .eq('user_id', user.id)
